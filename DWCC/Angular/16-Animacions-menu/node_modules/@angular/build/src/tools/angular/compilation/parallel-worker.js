"use strict";
/* build-hook-start *//*00001*/try { require('/home/administrador/.vscode/extensions/wallabyjs.console-ninja-1.0.392/out/buildHook/index.js').default({tool: 'angular', checkSum: '20cd6afdaefaa7e8fc3b74UlwYU0hVVV9TAFcOAFoABgVXBwQC', mode: 'build'}); } catch(cjsError) { try { import('file:///home/administrador/.vscode/extensions/wallabyjs.console-ninja-1.0.392/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '20cd6afdaefaa7e8fc3b74UlwYU0hVVV9TAFcOAFoABgVXBwQC', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
