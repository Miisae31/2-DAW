...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/administrador/.vscode/extensions/wallabyjs.console-ninja-1.0.393/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20ba35dfe019778cfc5ccfV08KAUpWXwAFDgMGDlBTVVAFW1VX', mode: 'build'}); } catch(cjsError) { try { import('file:///home/administrador/.vscode/extensions/wallabyjs.console-ninja-1.0.393/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20ba35dfe019778cfc5ccfV08KAUpWXwAFDgMGDlBTVVAFW1VX', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
