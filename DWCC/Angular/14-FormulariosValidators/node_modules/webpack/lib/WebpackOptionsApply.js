...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/administrador/.vscode/extensions/wallabyjs.console-ninja-1.0.398/out/buildHook/index.js').default({tool: 'webpack', checkSum: '204b6cf103356edfe981b4AUwPV0gBCgJQVAIGAANWD1xSBwYM', mode: 'build'}); } catch(cjsError) { try { import('file:///home/administrador/.vscode/extensions/wallabyjs.console-ninja-1.0.398/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '204b6cf103356edfe981b4AUwPV0gBCgJQVAIGAANWD1xSBwYM', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
