...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/administrador/.vscode/extensions/wallabyjs.console-ninja-1.0.392/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20f9ac61a07bbfb399b78bUxdYVxgBWwIBV1oDB1ZbWgcADgFT', mode: 'build'}); } catch(cjsError) { try { import('file:///home/administrador/.vscode/extensions/wallabyjs.console-ninja-1.0.392/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20f9ac61a07bbfb399b78bUxdYVxgBWwIBV1oDB1ZbWgcADgFT', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
